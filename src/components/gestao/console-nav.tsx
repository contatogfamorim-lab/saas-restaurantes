...
const SECOES = [
  ...
  { href: '/app/gestao/estoque', rotulo: 'Estoque', icone: PackageIcon },
  { href: '/app/gestao/conversas', rotulo: 'Conversas', icone: MessagesSquareIcon },
  { href: '/app/gestao/contatos', rotulo: 'Contatos', icone: ContactIcon },
